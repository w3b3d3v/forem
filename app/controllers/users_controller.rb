class UsersController < ApplicationController
  ...
  after_action :verify_authorized, except: %i[index signout_confirm add_org_admin remove_org_admin remove_from_org confirm_destroy connect_wallet delete_wallet]
